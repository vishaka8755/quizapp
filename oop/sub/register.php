<?php include '../code/authentication_code.php'; ?>
...
<p>
	 ...
	 <div class="form-group form-group-lg">
  	...
  	<div class="form-group form-group-lg">
		...
		<div class = "col-xs-1">
  	  <input type="text" class="form-control input-sm " name="password_1" id="inputpassword" placeholder="input password">
		</div></div>

  	<div class="form-group form-group-lg">
  	  <label for =id="inpupassword" class="control-label col-xs-1">Confirm password</label>
		<div class = "col-xs-1">
  	  <input type="text" class="form-control input-sm " name="password_2" id="inpupassword" placeholder="re enter password">
  	</div></div></br></br></br>
